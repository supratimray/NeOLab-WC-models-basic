...
function [eFR,iFR,peakA,peakFreq,harmonicA] = test_WCJS2014withLR(e0,i0,displayFlag,beta)
...
% Adjust the weights based on the LR inputs
weLR = 6;
wcParams.Wee = wcParams.Wee + weLR*beta;
%wcParams.Wei = wcParams.Wei + weLR*beta;
